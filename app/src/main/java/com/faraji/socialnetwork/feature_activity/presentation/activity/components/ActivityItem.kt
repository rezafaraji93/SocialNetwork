package com.faraji.socialnetwork.presentation.activity.components
...
import com.faraji.socialnetwork.core.domain.models.Activity
    ...
    Card(
        ...
        Row(
            ...
            val fillerText = when (activity.actionType) {
                ...
                is ActivityAction.FollowedYou -> stringResource(id = R.string.followed_you)
            }
